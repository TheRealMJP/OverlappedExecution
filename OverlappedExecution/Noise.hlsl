...
// Source code for the noise functions is released under the conditions of the MIT license.
...
float cnoise(float4 P)
{
  ...
  float4 sw00 = step(gw00, 0.0.xxxx);
  ...
  float4 sw01 = step(gw01, 0.0.xxxx);
  ...
  float4 sw10 = step(gw10, 0.0.xxxx);
  ...
  float4 sw11 = step(gw11, 0.0.xxxx);
