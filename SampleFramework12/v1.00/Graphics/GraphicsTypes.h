...
struct Buffer
{
    ...
    void Initialize(uint64 size, uint64 alignment, bool32 dynamic, BufferLifetime lifetime, bool32 allowUAV,
...
template<typename T> struct ConstantBuffer
{
    ...
    {
        InternalBuffer.Initialize(sizeof(T), DX12::ConstantBufferAlignment, true, lifetime, false, nullptr,
                                  D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER, nullptr, 0, nullptr);
    }
